...
async function main() {
    const clubs = JSON.parse(fs.readFileSync("C:/Users/andre/OneDrive/Documentos/gaiensespt/scrapers/scraped_clubs.json", "utf8"));
    ...
    for (const club of clubs) {
        ...
        if (r.error) { errors++; if (errors <= 3) console.log("Error " + club.id + ": " + r.error.message); }
        else updated++;
    }
