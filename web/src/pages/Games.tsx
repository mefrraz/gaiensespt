...
function Games() {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 pb-24">
            ...
            {/* Segment Controller */}
            <div className="sticky top-20 z-40 bg-white/80 dark:bg-black/80 backdrop-blur-xl p-1.5 rounded-2xl border border-zinc-200 dark:border-white/10 flex gap-1 shadow-xl mx-2 max-w-sm mx-auto mt-4">
                <button
