...
import { Trophy, ChevronRight, Loader2, Calendar } from 'lucide-react'
                    ...
                    <div className="sticky top-24 space-y-6">
                        <div className="flex items-center gap-3 md:mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] md:text-xs text-zinc-500 font-medium uppercase tracking-wide">Época 2024/2025</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            {Object.entries(groupedStandings).length === 0 ? (
                                ...
                                Object.entries(groupedStandings).map(([grupo, teams]) => (
                                    <div key={grupo} className="glass-card overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
                                        <div className="bg-gradient-to-r from-zinc-50 to-white dark:from-white/5 dark:to-zinc-900/50 p-6 border-b border-zinc-100 dark:border-white/5 flex justify-between items-center">
                                            <div>
                                                ...
                                                <h3 className="text-lg font-bold text-zinc-900 dark:text-white">{grupo}</h3>
                                            </div>
