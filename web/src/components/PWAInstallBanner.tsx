    ...
    function renderInstructions() {
            ...
            return (
                <div className="flex flex-col gap-2.5 items-center">
                    <button onClick={handleNativeInstall}
                        className="w-full sm:w-auto px-6 py-3 bg-violet-600 text-white text-sm font-bold rounded-xl hover:bg-violet-500 transition-colors shadow-md shadow-violet-600/20">
                        Instalar App
                    </button>
        ...
        return (
            <Link to="/install" onClick={handleDismiss}
                className="px-6 py-3 bg-violet-600 text-white text-sm font-bold rounded-xl hover:bg-violet-500 transition-colors shadow-md shadow-violet-600/20">
                Ver instruções
            </Link>
        )
    }
        ...
        <>
            ...
            <div className={`fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-zinc-900 rounded-t-3xl shadow-2xl transition-transform duration-300 ${dismissed ? 'translate-y-full' : 'translate-y-0'}`}>
                ...
                <div className="p-5 sm:p-6 text-center">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-violet-600 to-violet-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-violet-600/20">
